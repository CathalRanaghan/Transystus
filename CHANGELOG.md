...
- Removed capitalisation for file and directory names
- Replaced spaces with `-` for file and directory names
- Sorted array elements alphabetically for better readability
